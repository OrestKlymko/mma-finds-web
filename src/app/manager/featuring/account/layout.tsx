...
function Layout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="w-full flex flex-col gap-8">
      ...
      <ul className="flex justify-between gap-8 border-b border-gray-light">
        <li>
          <NavLink
            className="text-base font-medium pb-2 block h-full"
            href="/manager/featuring/account"
            hovered
          >
            Account Info
          </NavLink>
        ...
        <li>
          <NavLink
            ...
            href="/manager/featuring/account/subscriptions"
            hovered
          >
            Subscriptions
          </NavLink>
        ...
        <li>
          <NavLink
            className="text-base font-medium  block h-full"
            href="/manager/featuring/account/payment-methods"
            hovered
          >
            Payment Methods
          </NavLink>
        ...
        <li>
          <NavLink
            className="text-base font-medium  block h-full"
            href="/manager/featuring/account/management"
            hovered
          >
            Account Management
          </NavLink>

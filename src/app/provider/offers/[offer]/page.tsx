...
import SetDueDate from '../../../../components/Modal/components/SetDueDateModal';
        ...
        <div className="max-w-screen-xl mx-auto flex gap-20 mb:flex-col-reverse mb:gap-12">
          ...
          <div className="w-1/4 shrink-0 mb:w-full">
            {isFeatured ? (
              ...
              <button
                className="w-full text-green rounded-md mb-4 mt-2
              "
                onClick={() => openModal(<SetDueDate isRenew />)}
              >
                Renew the Offer
              </button>
            )}
